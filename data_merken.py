...
OVERIGE_MERKEN = ["Abarth", "Bentley", "BYD", "Cadillac", "Chevrolet", "Chrysler", "Cupra", "Daewoo", "Daihatsu", "Ferrari",
                  "Infiniti", "Isuzu", "Lamborghini", "Lancia", "Lotus", "Lynk & Co", "Maserati", "MG", "Polestar", "Rover",
                  "Saab", "SsangYong", "Subaru"]
