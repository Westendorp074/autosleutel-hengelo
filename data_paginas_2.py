...
<section class="sectie sectie--kort"><div class="wrap wrap--tekst artikel">
  ...
  <ul>
    ...
    <li><strong>Websitebezoek:</strong> alleen de technische gegevens die nodig zijn om de site te tonen. Wij meten geen bezoekers, houden geen statistieken bij en gebruiken geen advertentiecookies.</li>
  </ul>
  <h2>Waarvoor</h2>
  <ul>
  ...
  <h2>Cookies</h2>
  <p>Deze website gebruikt <strong>geen tracking-, analyse- of advertentiecookies</strong> en meet niet wat u op de site doet. Daarom ziet u geen cookiemelding. Verandert dat, dan vragen wij eerst uw toestemming en passen wij deze verklaring aan.</p>
